...
import com.rk.presentation.home.adapters.CalorieAdapter
import com.rk.presentation.home.adapters.KilometerAdapter
import com.rk.presentation.home.adapters.StepAdapter
import com.rk.presentation.home.adapters.SuccessAdapter
        ...
        viewModel.state.collect(lifecycleScope) { it ->
            ...
            if (!it.week.isNullOrEmpty()) {
                ...
                val list = arrayListOf(
                    Step(1, viewModel.name(day, month, year), day, month, year, 0, 0, 0.0, 0, 0.0, 0, false)
                )
